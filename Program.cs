...
const string connectionString = "AccountEndpoint=https://mslearn-151337500.documents.azure.com:443/;AccountKey=csL5k1w1nsqZGtTywNXtgJM6Q5Vo9WMgaF5Y2vq3kv3Dli6rNx9XZXbCgVdlwCmeYGNkdUQCESTyACDbyU8o3w==;";
...
ContainerProperties properties = new (id:"procucts",partitionKeyPath:"/categoryId");

var throughtput = ThroughputProperties.CreateAutoscaleThroughput(autoscaleMaxThroughput:1000);

Container container = await database.CreateContainerIfNotExistsAsync(
    containerProperties:properties,
    throughputProperties:throughtput
);
